...
const PaymentPage = () => {
  ...
  const handlePayment = () => {
    axios
      .post(
        process.env.NEXT_PUBLIC_BACKEND_URL + "/api/v1/transaction/create-payment",
        {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8">
          ...
          <div className="flex flex-col justify-center p-6  border-gray-200">
            ...
            <p className="font-light text-justify mt-1 max-w-full sm:max-w-[600px]">
              Untuk menyelesaikan pemesanan, lakukan pembayaran melalui QRIS dengan men-scan QR Code di samping
              menggunakan bank atau e-wallet yang telah support dengan QRIS.
            </p>
            <button
